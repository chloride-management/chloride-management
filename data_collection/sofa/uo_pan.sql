DROP MATERIALIZED VIEW IF EXISTS uo_pan CASCADE;
create materialized view uo_pan as
select
  -- patient identifiers
  ie.subject_id, ie.hadm_id, ie.icustay_id, ceiling((extract( epoch from oe.charttime - ie.intime))/60/60/24) as day
...
) AND oe.charttime between ie.intime and ie.outtime
