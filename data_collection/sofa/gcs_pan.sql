DROP MATERIALIZED VIEW IF EXISTS gcs_pan CASCADE;
create materialized view gcs_pan as
with base as
(
  ...
  and l.error IS DISTINCT FROM 1 and l.charttime between b.intime and b.outtime
  ) pvt
